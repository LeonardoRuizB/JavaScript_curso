...
function celsiusToFaFahrenheit(temp_c) {
...
var fahrenheit = celsiusToFaFahrenheit(celsius);
...
var curso = {
    ...
    'n_aval_1_estrela': 4,
    'total_aval': function() {
        var t_aval = this.n_aval_1_estrela + this.n_aval_2_estrelas + this.n_aval_3_estrelas + this.n_aval_4_estrelas + this.n_aval_5_estrelas;
        return t_aval;
    },
    'media_aval': function() {
        var m_aval = ((this.n_aval_5_estrelas * 5) + (this.n_aval_4_estrelas * 4) + (this.n_aval_3_estrelas * 3) + (this.n_aval_2_estrelas * 2) + (this.n_aval_1_estrela * 1)) / this.total_aval();
        return m_aval;
    }
}
